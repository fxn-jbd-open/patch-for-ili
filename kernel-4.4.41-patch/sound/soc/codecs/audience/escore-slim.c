...
int escore_remote_cfg_slim_rx(int dai_id)
{
	...
	es_profiling_end(&rx_cfg);
	print_profiling_time(rx_cfg, "switch route");
...
int escore_remote_cfg_slim_tx(int dai_id)
{
	...
	es_profiling_end(&tx_cfg);
	print_profiling_time(tx_cfg, "switch route");
